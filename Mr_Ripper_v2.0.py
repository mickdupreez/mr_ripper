...
class Directories:
    ...
    def __init__(self):
        ...
        self.create_plex_subdirs() # Call the create_plex_subdirs method
    ...
    def create_plex_subdirs(self):
        """
            This method creates the directories in the plex directory for the letters A to Z
        """
...
def refresh():
    ...
    while True:
        ...
        if len(Directories().compressed_list) != len(compressed_dir_listbox.get(0, END)):
            ...
            for letter in Directories().plex_list:
                for i in os.listdir(f"{Directories().plex}{letter}"):
                    print(i)
